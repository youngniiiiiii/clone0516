...
<div class="col-sm-2 leftnav">
    <div class="left-category">
        <a href="/item/top" class="left-category-ko">상의 전체</a>
        <span class="left-category-en">Top</span>
    </div>
    <div class="left-category">
        <a href="/item/tshirt" class="left-category-ko">티셔츠</a>
        <span class="left-category-en">T-shirt</span>
    </div>
    <div class="left-category">
        <a href="/item/jacket" class="left-category-ko">자켓</a>
        <span class="left-category-en">Jacket</span>
    </div>
    <div class="left-category">
        <a href="/item/shirt" class="left-category-ko">셔츠</a>
